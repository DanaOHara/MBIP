...
class ContextsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create context" do
    assert_difference('Context.count') do
      post contexts_url, params: { context: { contextlevel: @context.contextlevel, depth: @context.depth, instanceid: @context.instanceid, path: @context.path } }
    end
  ...
  test "should update context" do
    patch context_url(@context), params: { context: { contextlevel: @context.contextlevel, depth: @context.depth, instanceid: @context.instanceid, path: @context.path } }
