...
class ContextsTest < ApplicationSystemTestCase
  ...
  test "creating a Context" do
    ...
    fill_in "Contextlevel", with: @context.contextlevel
    fill_in "Depth", with: @context.depth
    fill_in "Instanceid", with: @context.instanceid
    fill_in "Path", with: @context.path
