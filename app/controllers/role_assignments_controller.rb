class RoleAssignmentsController < ApplicationController
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to role_assignments_url, notice: 'Role assignment was successfully destroyed.' }
  ...
  private
    ...
    def role_assignment_params
      params.require(:role_assignment).permit(:roleid, :contextid, :userid, :timemodified, :modifierid, :component, :itemid, :sortorder)
    end
end
