class AssignmentSubmissionsController < ApplicationController
  ...
  private
    ...
    def assignment_submission_params
      params.require(:assignment_submission).permit(:assignment, :userid, :timecreated, :timemodified, :numfiles, :data1, :data2, :grade, :submissioncomment, :format, :teacher, :timemarked, :mailed)
    end
end
